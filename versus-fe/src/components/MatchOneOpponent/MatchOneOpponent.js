  ...
  return (
    ...
    <div className="MatchOneOpponent"> 
      ...
      {props.opponent ? 
       ...
       <div className="MatchOneOpponent flip-container" ontouchstart={handleFlip}>

        <div className="MatchOneOpponent__picture flipper">
      
          {props.opponent ? 
            <img src={props.opponent.image_path} alt="opponent picture" className="front"/>
            : 
          <img src={props.user.image_path} alt="opponent picture" className="front"/>
          }
